      ...
      <div className="glass rounded-3xl p-8 w-full max-w-sm scale-in">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl font-medium text-sm transition-all hover:scale-[1.02] active:scale-[0.98] bg-white text-gray-900">
