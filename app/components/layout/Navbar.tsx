    ...
    <div className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 h-14"
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          {(() => {
            const pc: Record<string,string> = { admin:'#F59E0B', max:'#FF6B2B', premium:'#FF6B2B', pro:'#A78BFA', starter:'#1A73E8', free:'#10A37F', none:'#6B7280' }
          ...
          {showProfileMenu && (
            <>
              ...
              <div className="absolute right-0 top-11 w-56 rounded-2xl overflow-hidden shadow-2xl z-50"
                ...
                {(() => {
                  const planColors: Record<string,string> = { admin:'#F59E0B', max:'#FF6B2B', premium:'#FF6B2B', pro:'#A78BFA', starter:'#1A73E8', free:'#10A37F', none:'#6B7280' }
